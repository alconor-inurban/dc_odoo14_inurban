odoo.define('sample.dashboard', function (require) {
"use strict";
...
let dashboardValues;
SampleServer.mockRegistry.add('sample.order/retrieve_dashboard', () => {
...
var PurchaseListDashboardRenderer = ListRenderer.extend({
    ...
    _renderView: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var purchase_dashboard = QWeb.render('sample.PurchaseDashboard', {
                values: values,
            });
